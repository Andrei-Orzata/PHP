...
if(isset($_SESSION['logat'])){
    die(header("Location:https://orzataandreiphp.000webhostapp.com/Home/"));
}
...
if(isset($_POST['submit']))
{
    ...
    if($result)
    {
        header("https://orzataandreiphp.000webhostapp.com/login/");
    }
    ...
    <body>
        <div class ="registerbox">
            ...
            <form action="<?php echo $_SERVER['PHP_SELF']?>" method="post">
                ...
                <a href="https://orzataandreiphp.000webhostapp.com/login/">Login-in instead</a><br>
